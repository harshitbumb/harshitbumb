...
const cuteAlert = ({
  ...
  return new Promise((resolve) => {
    ...
    let btnTemplate = `
    <button class="popup-okay-button uk-button uk-button-primary uk-button-large  yb-btn">${buttonText}</button>
    `;
    ...
    if (type === "question") {
      ...
      const alertButton = document.querySelector(".popup-okay-button");
